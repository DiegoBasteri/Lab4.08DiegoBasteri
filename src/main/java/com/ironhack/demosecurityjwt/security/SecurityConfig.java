...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(POST,"api/addPost").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(GET,"api/getAuthor/**").permitAll()
                .requestMatchers(GET,"api/getPost/**").permitAll()
                .requestMatchers(POST,"api/addAuthor").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "api/users").hasAnyAuthority("ROLE_ADMIN","ROLE_USER")
                .requestMatchers(POST,"api/addPost").hasAnyAuthority("ROLE ADMIN")
                .requestMatchers(DELETE,"api/deletePost").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(DELETE,"api/deleteAuthor").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(PUT,"api/updatePost").hasAnyAuthority("ROLE_ADMIN")
